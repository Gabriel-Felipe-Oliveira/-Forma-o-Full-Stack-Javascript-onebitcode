...
const elementosRemovidos2 = sociedade.splice(indice, 1, "Gandalf, o Cinzento")
console.log(elementosRemovidos2)
console.log(sociedade)

// splice: Permite remover elementos em qualquer posição do array e substituir por novos
const elementosRemovidos3 = sociedade.splice(indice, 1, "Gandalf, o Cinzento")
console.log(elementosRemovidos3)
console.log(sociedade)